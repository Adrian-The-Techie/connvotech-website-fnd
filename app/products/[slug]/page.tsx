        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-4 space-y-8">
            <div className="bg-brand-bg p-8 rounded-[40px] border border-border-gray shadow-premium-card sticky top-32">
              <h3 className="text-xl font-display font-black text-brand-black mb-8 tracking-tight border-b border-border-gray pb-4">Product Details</h3>
              <div className="space-y-8">
                <div className="flex gap-4">
                  ...
                  <div>
                    <p className="text-[10px] font-black uppercase tracking-widest text-text-gray mb-1">Technology Stack</p>
                    <p className="font-bold text-brand-black leading-tight">{product.tech_stack || "Enterprise Suite"}</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <p className="text-[10px] font-black uppercase tracking-widest text-text-gray mb-1">Availability</p>
                    <p className="font-bold text-brand-black leading-tight">{product.is_coming_soon ? "Roadmap Phase" : "Available Now"}</p>
                  </div>
                </div>

                <div className="pt-4">
                  <p className="text-[10px] font-black uppercase tracking-widest text-text-gray mb-4">Key Features</p>
                  <div className="space-y-3">
                    {product.features_list?.slice(0, 5).map((feature, idx) => (
                      <div key={idx} className="flex items-center gap-3 text-xs font-bold text-brand-black">
